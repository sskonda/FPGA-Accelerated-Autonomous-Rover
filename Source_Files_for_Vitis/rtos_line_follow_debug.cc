 ...
 * ============================================================ */
/* ROI = bottom band of the frame where the line is expected to appear */
#define ROI_Y_TOP               720     /* 720..1079 = bottom 360 rows */
#define ROI_Y_BOTTOM            (FRAME_H - 1)
...
static void vMotorTask(void *) {
    ...
    for (;;) {
        ...
        if (s.sonar_ok && s.obstacle) {
            ...
            /* Positive err_px = line is to the RIGHT of image center.
             * To steer right, LEFT wheels should spin faster than RIGHT. */
